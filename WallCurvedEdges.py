...
for x in range(11):
    box1(2.375+(3.75*x),0,1.75,2.75,100,4.125,'free_space')

for x in range(11):
    box1(2.875+(3.75*x),0,1.25,1.75,100,5.125,'free_space')

for x in range(11):
    for z in range(2):
        y_cylinder(4.625+(3.75*x),0,1.75+(4.125*z),100,0.5,'free_space')

for x in range(11):
    for z in range(2):
        y_cylinder(2.875+(3.75*x),0,1.75+(4.125*z),100,0.5,'free_space')
