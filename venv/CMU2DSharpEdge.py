...
hertzian_source('ricker', 1, 1.5*(10**9), 'y', 0.93388, 0, 7.63778)
receiver(2.51968, 0, 7.63778)

steps(0.15748, 0, 0)

box1(0, 0, 0, 15.25, 0.07874, 7.625, 'testconc')

box1(0, 0, 1.25, 1.625, 0.07874, 5.125, 'free_space')
box1(13.625, 0, 1.25, 1.625, 0.07874, 5.125, 'free_space')

for x in range(3):
    box1(2.625+(3.75*x), 0, 1.25, 2.75, 0.07874, 5.125, 'free_space')

y_cylinder(3, 0, 3.75, 0.07874, 0.125, 'testmetal')
y_cylinder(10.5, 0, 4.25, 0.07874,  0.125, 'testmetal')
