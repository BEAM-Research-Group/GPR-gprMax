...
discretization(0.03937, 0.03937, 0.03937)
...
box1(0,0,1.25,0.875,8,5.125,'free_space')
box1(0,0,1.75,1.375,8,4.125,'free_space')

box1(14.375,0,1.25,0.875,8,5.125,'free_space')
box1(13.625,0,1.75,1.375,8,4.125,'free_space')

for x in range(3):
    box1(2.375+(3.75*x),0,1.75,2.75,8,4.125,'free_space')

for x in range(3):
    box1(2.875+(3.75*x),0,1.25,1.75,8,5.125,'free_space')

for x in range(4):
    for z in range(2):
        y_cylinder(0.875+(3.75*x),0,1.75+(4.125*z),8,0.5,'free_space')

for x in range(4):
    for z in range(2):
        y_cylinder(2.875+(3.75*x),0,1.75+(4.125*z),8,0.5,'free_space')
